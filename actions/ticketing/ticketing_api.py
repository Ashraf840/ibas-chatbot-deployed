...
# def sender_id(self, dispatcher: CollectingDispatcher,
#             tracker: Tracker,
...
def get_user_detail():
    response = requests.get(f'http://192.168.0.23:8000/home/api/user-chatbot/socket/5fa6894a-e26b-48bb-82cc-30a73be70755/')
    data = response.json()
    return data
...
#     data = response.json()
#     return data.get('text')[0].get('text') if data and data.get('text') else None
...
# 	"chatbot_socket_id": "9e766b57696f4f61af7f83a1d6550c27"
# }
#     response = requests.post(
#         "http://192.168.0.23:8000/home/api/user-chatroom/socket/",
#         headers= headers
#     )
...
#     conn.request("POST", "/home/api/user-chatroom/socket/", payload, headers)
...
def redirect_to_cso_chatroom():
    ...
    response = requests.post(
        "http://192.168.0.23:8000/home/api/user-chatroom/socket/", payload,
        headers= headers
    )
